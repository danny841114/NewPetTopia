...
public class ShopCartController {
    ...
    // 會員購物車頁面
    @PostMapping
    public ResponseEntity<List<Cart>> showMemberCart(@RequestParam Integer memberId) {
    ...
    public ResponseEntity<Cart> updateCartProductQuantity(@RequestParam Integer memberId,
    ...
    public ResponseEntity<byte[]> getPhoto(@RequestParam Integer productId) {
    ...
    public ResponseEntity<Void> deleteCartById(@RequestParam Integer cartId) {
    ...
    // 會員購物車頁面 => 獲取會員優惠券
    @GetMapping("/coupons")
    public ResponseEntity<Map<String, Object>> getCoupons(@RequestParam Integer selectedCouponId,

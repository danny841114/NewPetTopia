...
public class ShopProductDetailController {
    ...
    public ResponseEntity<?> getConfirmProduct(@RequestParam Integer memberId,
    ...
    public ResponseEntity<?> getProductByOption(@RequestParam Integer productDetailId,
    ...
    public ResponseEntity<?> getProductByProductDetailId(@RequestParam Integer productDetailId, Model model) {
        Map<String, Object> responseData = new HashMap<>();

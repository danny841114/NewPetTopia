...
//    private String hashIv;
    ...
    public String createCheckValue(Map<String, String> params) throws NoSuchAlgorithmException {
        Map<String, String> sortedParams = new TreeMap<>(params);
        StringBuilder sb = new StringBuilder();

        for (Map.Entry<String, String> entry : sortedParams.entrySet()) {
            if ("CheckMacValue".equals(entry.getKey())) continue;
        ...
        String lowerCaseString = encodeString(sb.toString()).toLowerCase();
    ...
    public boolean isValidCheckValue(Map<String, String> callbackParams) throws NoSuchAlgorithmException {
